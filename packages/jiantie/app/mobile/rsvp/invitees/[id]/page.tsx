...
export default function InviteeDetailPage() {
  ...
  const handleShareInvitee = async () => {
    ...
    // 跳转到分享页面
    const shareUrl = `/mobile/rsvp/share?works_id=${worksId}&mode=invitee&contact_id=${invitee.id}&contact_name=${encodeURIComponent(invitee.name)}&form_config_id=${formConfigId}&from=detail`;
