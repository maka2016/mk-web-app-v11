...
export default function Main({
  ...
  const themeMap: Record<
    string,
    { themeColor: string; themeBgGradient: string }
  > = {
    jiantie: {
      themeColor: '#d53933',
      themeBgGradient:
        'linear-gradient(229.87deg, rgba(242, 155, 227, 0.5) 1.92%, rgba(255, 255, 255, 0.5) 28.84%), linear-gradient(135.77deg, rgba(242, 155, 155, 0.5) 7.08%, rgba(255, 255, 255, 0.5) 38.06%), linear-gradient(90deg, rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 1) 100%)',
    },
    maka: {
      themeColor: '#3358d4',
      themeBgGradient:
    ...
    avite: {
      themeColor: '#ffd966',
      themeBgGradient:
        'linear-gradient(229.87deg, rgba(255, 217, 102, 0.6) 1.92%, rgba(255, 255, 255, 0.5) 38.84%), linear-gradient(135.77deg, rgba(255, 204, 51, 0.5) 17.08%, rgba(255, 255, 255, 0.4) 38.06%), linear-gradient(90deg, rgba(255, 254, 249, 1) 0%, rgba(255, 254, 249, 1) 100%)',
    },
  };
  const defaultTheme = themeMap.maka;
  const theme = themeMap[appid] ?? defaultTheme;
  const themeColor = theme.themeColor;
  const themeBgGradient = theme.themeBgGradient;

  // linear-gradient(to right, rgb(134, 220, 255) 0%, rgb(26, 134, 255) 100%)

  const toNotificationCenter = () => {
    nav.push('/mobile/rsvp/notifications');
  };
