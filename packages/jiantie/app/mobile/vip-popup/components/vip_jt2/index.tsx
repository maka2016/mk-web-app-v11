            ...
            <div className={styles.singleContent}>
              ...
              <div className={styles.singleInfo}>
                <div className={styles.singleTitle}>
                  单份支付{' '}
                  <span className={styles.singleSubtitle}>
                    (仅支持当前作品)
                  </span>
                </div>
          ...
          >
            <div
              className={cls([
                ...
                paymentType === 'annual' && styles.annualContent,
              ])}
            >
              <div className={styles.radioButton}>
                {paymentType === 'annual' && (
              ...
              <div
                className={cls([
                  styles.singleInfo,
                  paymentType === 'annual' && styles.annualInfo,
                ])}
              >
                <div
                  className={cls([
                    styles.singleTitle,
                    paymentType === 'annual' && styles.annualTitle,
                  ])}
                >
                  <span>全部模板免费用</span>
                </div>
                <div
                  className={cls([
                    styles.singleDesc,
                    paymentType === 'annual' && styles.annualFeatures,
                  ])}
                >
                  <div
                    className={cls([
                      paymentType === 'annual' && styles.featureItem,
                    ])}
                  >
                    <span>无限量模板 & 无限次下载</span>
                  </div>
                  <div
                    className={cls([
                      paymentType === 'annual' && styles.featureItem,
            ...
            {paymentType === 'annual' && (
              <div className={styles.privilegeCard}>
                <div className={styles.privilegeKeywords}>
                  <span>结婚</span>
                ...
                <div className={styles.privilegeSlogan}>人生喜宴, 简帖邀约</div>
              </div>
            )}
          </div>
        )}
...
export default observer(JTVip2);
