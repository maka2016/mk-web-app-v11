...
import HomeChannelPage from './channel/page';
import Works from './works/page';

// Tabs 配置
const tabs = [
  { label: '商城', key: 'store', component: HomeChannelPage },
...
const HomeComp = (props: Props) => {
  ...
  const { setLoginShow, loginShow } = useStore();
  ...
  // 桌面端显示模板商城（channel 页面）
  if (!isMobile) {
    return (
      <div className='h-full overflow-auto'>
        <HomeChannelPage activeTabDefault='2026' useVersionSwitch={false} />
      </div>
    );
  }
