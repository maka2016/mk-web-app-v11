...
import { getAppId, getToken2, getUid, startupStsOssClient } from '@mk/services';
...
const OssUploader = forwardRef<OssUploaderMethods, Props>((props, ref) => {
  ...
  return (
    <div className={clas(styles.ossuploaderWrap, className)}>
      <input
        type='file'
      ...
      {
        <div
          className={cls(!props.disabled && 'cursor-pointer')}
          style={{ height: '100%' }}
          onClick={() => {
