...
import { isMakaAppAndroid, isMakaAppClient, setCookie } from '@mk/utils';
    ...
    <div className={cls([styles.mine, styles[appid]])}>
      ...
      <div className={styles.menus}>
        ...
        >
          ...
          <div className='flex-1'>
            <div className={cls([styles.tit])}>模板中心</div>
        ...
        >
          ...
          <div className='flex-1'>
            <div className={cls([styles.tit])}>回收站</div>
        ...
        >
          ...
          <div className='flex-1'>
            <div className={cls([styles.tit])}>会员卡兑换</div>
