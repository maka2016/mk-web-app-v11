...
import { getAppId, getWorksDetail, request } from '@/services';
...
const Posterdownload = () => {
  ...
  const { isVip, customerVips } = useStore();
  ...
  const toWorks = () => {
    // const url = `${location.origin}/records?is_full_screen=1`;
  ...
  return (
    <div className={styles.posterdownload}>
