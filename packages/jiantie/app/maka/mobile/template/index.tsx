...
const TemplateDetail = (props: Props) => {
  ...
  const pageInstId = useRef(`template_page_${random(25).toUpperCase()}`);
  ...
  const initData = async () => {
    ...
    mkWebStoreLogger.track_pageview({
      ...
      page_id: templateId,
      page_inst_id: pageInstId.current,
  ...
  const renderH5Preview = () => {
    ...
    if (detail.page_width && detail.page_height) {
      ...
      style = {
        ...
        height: `${(clientHeight - 44) / scale}px`,
      ...
      <div className={styles.h5Detail}>
        ...
        >
          ...
          <div className={styles.h5Info}>
            ...
            <div className={cls([styles.btn, styles.h5Btn])}>
