...
import { API, cdnApi, getWorksData } from '@mk/services';
import { objToQuery, queryToObj } from '@mk/utils';
...
const Share = () => {
  ...
  const getWorkDetailInfo = async () => {
    ...
    if (detail.thumb || detail.first_img) {
      setShareIcon(detail.thumb || detail.first_img);
    }
  };
              ...
              <div
                ...
                onClick={async () => {
                  ...
                  const urlParams = {
                    ...
                    pageCount: '1',
                    url: shareLink,
                    width: String(worksData.canvasData.width * 2),
                    height: String(worksData.canvasData.height * 2),
                    appid,
                  };
