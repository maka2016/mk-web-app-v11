...
import { EventEmitter, SerializedWorksEntity, isAndroid } from '@/utils';
...
const MobileShareContent = ({
  ...
  return (
    <div className='flex flex-col h-full'>
      <Header
        leftText={isShareMode ? t('backToPreview') : t('back')}
        hideInPc={false}
        title={isShareMode ? t('share') : t('preview')}
