...
function PageManagerForUser() {
  ...
  const { getRowByDepth, addRowFromTemplateV2, moveRowV2 } = worksStore.gridPropsOperator;
                  ...
                  >
                    ...
                    >
                      <div className='flex overflow-hidden'>
                        ...
                        <BtnLite
                          onClick={() => {
                            if (blockIdx === gridsData.length - 1) {
                              toast.error('已经是最后一个页面');
                              return;
                            }
                            moveRowV2('down', {
                              activeRowDepth: [blockIdx],
