        ...
        {!isAbsoluteElem ? (
          <>
            ...
            >
              ...
              <PopoverContent className='p-0 shadow-none rounded-b-none md:w-fit w-screen md:rounded-lg md:shadow-lg md:border-none overflow-hidden'>
                <div className='p-4'>
                  <div className='text-[12px] text-gray-500'>{t('adjustVertical')}</div>
                  <ToggleGroup
                    type='single'
                    value={
                  ...
                  <div className='flex gap-4 px-2'>
                    <div className='flex-1 flex flex-col gap-2'>
                      <div className='text-[12px] text-gray-500'>{t('topMargin')}</div>
                      <Slider
                        min={0}
                        max={64}
                        step={2}
                    ...
                    <div className='flex-1 flex flex-col gap-2'>
                      <div className='text-[12px] text-gray-500'>{t('bottomMargin')}</div>
                      <Slider
                        min={0}
                        max={64}
                        step={2}
