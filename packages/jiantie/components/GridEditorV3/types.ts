import { type LayerElemItem, type PositionAttrs } from '@/components/GridEditorV3/works-store/types';
import { type AnimateQueue2 } from '@/components/GridEditorV3/works-store/types/animate2';
...
export interface GridRow {
  ...
  /** 进场/强调/退场动画队列（与 layersMap 中 layer.animateQueue2 同结构） */
...
export interface GridProps {
  ...
  /** 前景动画 */
  lottieFgConfig?: LottieConfig;
  /** 禁用动画自动播放，需要用户通过点击「播放动画」按钮手动触发 */
  disableAutoPlayAnimation?: boolean;
}
