...
export const SplitView: React.FC<SplitViewProps> = ({
  ...
  const resetToDefault = useCallback(() => {
    ...
    setBottomCollapsed(false);
    closeContextMenu();
  }, [defaultTopHeight, closeContextMenu]);
  ...
  return (
    <SplitViewRoot ref={containerRef}>
      ...
      {contextMenu && (
        ...
        >
          <div className='menu-item' onClick={collapseTop}>
            <span className='menu-text'>收起上方面板</span>
            <span className='menu-shortcut'>拖至顶部</span>
          </div>
          <div className='menu-item' onClick={collapseBottom}>
            <span className='menu-text'>收起下方面板</span>
            <span className='menu-shortcut'>双击 / 拖至底部</span>
          </div>
          <div className='menu-separator' />
          <div className='menu-item' onClick={resetToDefault}>
            <span className='menu-text'>重置为默认高度</span>
          </div>
        </ContextMenu>
      )}
    </SplitViewRoot>
