    ...
    <div>
      ...
      >
          ...
          <Container>
                      ...
                      <OptionGroup>
                        ...
                        <div className='flex items-center gap-2'>
                          <Input
                            ...
                            variantSize='sm'
                            value={
                              (animationQueue.entrance?.[0].delay || 0) /
                                1000 || 0
                            }
                            onChange={e => {
                              const updatedValue = { ...animationQueue };
                    ...
                    {animationQueue?.entrance?.[0] && (
                      <OptionGroup>
                        ...
                        <Input
                          ...
                          variantSize='sm'
                          value={
                            animationQueue.entrance?.[0].parameters.delay /
                              1000 || 0
                          }
                          onChange={e => {
                            const updatedValue = { ...animationQueue };
            ...
            <ToggleButton onClick={() => onDeleteAnimation("exit")}>
              ...
              <AnimationContent>
                ...
                {animationQueue.emphasis &&
                  animationQueue.emphasis.length > 0 && (
                    <>
                      <OptionGroup>
                        <Label>动画速度(秒)</Label>
                        <Input
                          ...
                          variantSize='sm'
                          value={
                            animationQueue.emphasis?.[0].parameters.duration /
                              1000 || 0
                          }
                          onChange={e => {
                            const updatedValue = { ...animationQueue };
                      ...
                      <OptionGroup>
                        ...
                        <div className='flex items-center gap-2'>
                          ...
                          <Switch
                            checked={
                              animationQueue.emphasis?.[0].parameters.loop ===
                              true
                            }
                  ...
                  <OptionGroup>
                    ...
                    <ButtonGroup>
                      {animation2Data.text.exit.map(item => {
                        const isActive =
                          animationQueue.exit?.[0]?.id === item.id;
                        return (
                          <Button
                            key={item.id}
                            active={isActive}
                  ...
                  (animationQueue.exit[0].type === 'text' ? (
                    <OptionGroup>
                      ...
                      <Input
                        ...
                        variantSize='sm'
                        value={
                          (animationQueue.exit?.[0].delay || 0) / 1000 || 0
                        }
                        onChange={e => {
                          const updatedValue = { ...animationQueue };
                    ...
                    <OptionGroup>
                      ...
                      <Input
                        ...
                        variantSize='sm'
                        value={
                          animationQueue.exit?.[0].parameters.duration / 1000 ||
                          0
                        }
                        onChange={e => {
                          const updatedValue = { ...animationQueue };
                ...
                {animationQueue?.exit?.[0] && (
                  <OptionGroup>
                    ...
                    <Input
                      ...
                      variantSize='sm'
                      value={
                        animationQueue.exit?.[0].parameters.delay / 1000 || 0
                      }
                      onChange={e => {
                        const updatedValue = { ...animationQueue };
                        if (!updatedValue?.exit?.length) {
        ...
        <TabsContent value='layout' className='flex-1 overflow-hidden'>
          <AnimationTemplates elemId={targetId} />
        </TabsContent>
      </Tabs>
    </div>
  );
