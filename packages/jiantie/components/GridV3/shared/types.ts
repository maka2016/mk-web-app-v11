...
export interface GridProps {
  ...
  /** 作品的类型，用于区分作品是模版、主题还是用户作品 */
  worksCate?: 'template' | 'theme' | 'user';
  /**
   * 用于模版、作品关联主题包的documentId，是themePackV3.documentId
   */
  themePackV3RefId?: {
    /** 关联的主题包 themePackV3.documentId */
    documentId: string;
    /** 关联的主题包作品id */
    worksId: string;
    /** 主题包版本 */
  ...
  /**
   * 风格包，已废弃，合并到已废弃，使用themePackV3
   * @deprecated
   */
  stylePackV2: MaterialResourceTypeForStrapi;
...
export interface GridState {
  ...
  /** 是否显示列表编辑 */
  showRepeatListEditor?: boolean;
  /** 是否显示添加内容弹窗 */
  isAddModalShow?: boolean;
  showCreateLayoutForm?: boolean;
  showThemeChannelSelector?: boolean;
  /** 是否只渲染激活的画布 */
