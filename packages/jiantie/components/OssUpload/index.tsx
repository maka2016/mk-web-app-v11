...
import { OSSClientCompat } from '@mk/services/src/oss-client-compat';
import { getFileExtendingName, random } from '@mk/utils';
...
const OssUploader = forwardRef<any, Props>((props, ref) => {
  ...
  return (
    <div className={cls([styles.ossuploader, className])}>
      <input
        key={inputKey}
        ref={divRef}
        onChange={onChange}
