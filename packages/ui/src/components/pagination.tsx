...
>(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    className={cn(
      'flex flex-row items-center gap-1 w-full relative overflow-x-auto',
      className
    )}
    {...props}
  />
...
const PaginationPrevious = ({
  ...
  <PaginationLink
    ...
    size='default'
    className={cn('gap-1 pl-2.5 sticky left-0', className)}
    {...props}
  >
...
const PaginationNext = ({
  ...
  <PaginationLink
    ...
    size='default'
    className={cn('gap-1 pr-2.5 sticky right-0', className)}
    {...props}
  >
    <span>下一页</span>
