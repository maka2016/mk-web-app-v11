...
export interface APIEnvMapping {
  dev: APIMapping;
  test: APIMapping;
  staging: APIMapping;
  prod: APIMapping;
...
export type EnvTypes = keyof APIEnvMapping;
...
export const envFilter = (env: string): EnvTypes => {
  return (envMapping[env as EnvMappingKey] || env) as EnvTypes;
};

export const EnvConfig: APIEnvMapping = {
  dev: (() => {
    ...
    return {
      ...
      viewer: 'https://test5.maka.im/mk-viewer-7',
      工具服务: 'https://test5.maka.im/mk-fe-node',
      APIV8: 'https://apiv8-testing.maka.im',
      ...
      MkServer: 'https://test5.maka.im/node-api-server',
      营销云API: 'https://apig.testing.maka.im/pcloud',
      搜索云API: 'https://apig.testing.maka.im/ccloud',
      表单API: 'https://test5.maka.im/mk-form-engine',
      apiv10: 'https://apiv10-gateway.testing.maka.im',
      资源位服务API: 'https://gate.testing.maka.im',
      公开服务API: 'https://test5-pubservice.maka.im',
      卡劵服务API: 'https://coupon-marketing.testing.maka.im',
    };
  })(),
  test: (() => {
    const rootDomain = 'https://test5.maka.im';
    ...
    return {
      根域名: rootDomain,
      工具截图: domainWrapper('/mk-gif-generator'),
      viewer: domainWrapper('/mk-viewer-7'),
      APIV8: 'https://apiv8-testing.maka.im',
      api_v7: 'https://test5.maka.im/mk-api-services-v7',
      工具服务: 'https://test5.maka.im/mk-fe-node',
      主服务API: 'https://test5-apiv5.maka.im',
  ...
  staging: (() => {
    ...
    return {
      ...
      APIV8: 'https://apiv8-staging.maka.im',
      工具服务: 'https://staging.maka.im/mk-fe-node',
      主服务API: 'https://staging-apiv5.maka.im',
      营销助手服务API: 'https://staging-assistant.maka.im',
      查询服务API: 'https://staging-queryservice.maka.im',
      MkServer: 'https://staging.maka.im/node-api-server',
      营销云API: 'https://apig.staging.maka.im/pcloud',
      搜索云API: 'https://apig.staging.maka.im/ccloud',
      表单API: 'https://staging.maka.im/mk-form-engine',
      apiv10: 'https://staging-apiv10.maka.im',
      资源位服务API: 'https://gate.staging.maka.im',
      公开服务API: 'https://staging-pubservice.maka.im',
      卡劵服务API: 'https://coupon-marketing.staging.maka.im',
    };
  })(),
  prod: (() => {
    ...
    return {
      ...
      MkServer: 'https://www.maka.im/node-api-server',
      营销云API: 'https://apig.maka.im/pcloud',
      搜索云API: 'https://apig.maka.im/ccloud',
      表单API: 'https://www.maka.im/mk-form-engine',
      apiv10: 'https://apiv10.maka.im',
      资源位服务API: 'https://gate.maka.im',
      公开服务API: 'https://pubservice.maka.im',
      卡劵服务API: 'https://coupon-marketing.maka.im',
    };
  })(),
};
...
let runtimeEnv: EnvTypes = 'prod';

/**
 * 获取当前运行环境，优先级：url > process.env
 */
export const getCurrEnv = () => {
  return runtimeEnv || queryToObj().env || getProcessEnv();
};

export const setEnv = (nextEnv: EnvTypes) => {
  runtimeEnv = nextEnv;
};
