 ...
 * Original file: /npm/embla-carousel-react@8.5.1/embla-carousel-react.umd.js
 *
...
!(function (n, t) {
  ...
  function E(n, t, e, r, o, i, u, l, f, p, g, m, h, y, v, w, E, L, O) {
  ...
  function A(n, t, e, r, o) {
    ...
    function l(t, r) {
      ...
      return i.length ? d(i) : f(o) - e;
    }
    return {
      byDistance: function (e, r) {
        const a = o.get() + e,
          { index: d, distance: f } = (function (e) {
            const r = n ? c(e) : u(e),
              o = t
                ...
                ? l(n)
                    .reduce((e, o, l) => {
                      const y = f(e) || 0,
                        ...
                        E = s(S - (!r && b ? h(a) : 0) - (v + w));
                      return (
                        l && E > t + d && e.push(o), b && e.push(n.length), e
                      );
                    }, [])
                    .map((t, e, r) => {
  ...
  function j(n, t, e, r, o, c, u) {
    const {
        ...
        const { measureSize: c, startEdge: u, endEdge: a } = n,
          ...
          h = e
            .map((n, t, e) => {
              const r = !t,
                o = g(e, t);
              return r ? m[t] + l : o ? m[t] + p : e[t + 1][u] - n[u];
            })
            .map(s);
        return { slideSizes: m, slideSizesWithGaps: h, startGap: l, endGap: p };
      })(Z, Y, K, e, rn, o),
      an = H(Z, _, q, R, Y, K, un, sn, 2),
      { snaps: dn, snapsAligned: ln } = (function (n, t, e, r, o) {
        ...
        n =>
          ((
            ...
            const p = n.settled(),
              g = !d.shouldConstrain(),
              m = l ? p : p && g;
            m && !u.pointerDown() && (s.stop(), a.emit('settle')),
              m || a.emit('scroll');
      ...
      zn = {
        ...
        scrollLooper: I(fn, hn, Ln, [wn, Ln, En, On]),
        scrollProgress: Mn,
        scrollSnapList: mn.map(Mn.get),
        scrollSnaps: mn,
        scrollTarget: In,
        scrollTo: An,
        slideLooper: k(Z, _, fn, on, cn, dn, mn, Ln, e),
        slideFocus: Pn,
