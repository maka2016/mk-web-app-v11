...
import { ChangeBlockTrigger } from '../../ThemeLayoutLibraryV3/ChangeComponentTrigger';
...
export const SettingBlockDesigner = (props: GridMoreOptionsProps) => {
  ...
  const { blockGroupData } = themePackV3Data;
                  ...
                  <ComponentGroupSelector
                    ...
                    onSelect={group => {
                      ...
                      if (
                        ...
                        const item = themePackV3Data.getBlockItem(
                          currBlock.componentGroupRefId,
                          currBlock.sourceComponentId
                        );
                        if (item) {
                      ...
                      try {
                        ...
                        themePackV3Data.addBlockToGroup(
                          group.groupId,
                          createRes.data,
                          group.groupName
                        );
                        ...
                        if (confirm('该组件已存在，是否覆盖？')) {
                          ...
                          themePackV3Data.updateBlockData(
